          ...
          <div className="md:col-span-2">
            <div className="mb-4">
              ...
              <p className="text-zinc-400 mt-2">
                Tienda oficial del movimiento LevántateCuba.
                Cada compra apoya la causa de libertad.
              </p>
            </div>
            <div className="flex gap-4 mt-4">
              {/* Social Links */}
              <a
                href="https://twitter.com/levantatecuba"
                target="_blank"
              ...
              <a
                href="https://instagram.com/levantatecuba"
                target="_blank"
                rel="noopener noreferrer"
                className="text-zinc-400 hover:text-white transition-colors"
              ...
              <a
                href="https://facebook.com/levantatecuba"
                target="_blank"
                rel="noopener noreferrer"
                className="text-zinc-400 hover:text-white transition-colors"
                aria-label="Facebook"
        ...
        <div className="border-t border-zinc-800 mt-8 pt-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-zinc-400 text-sm">
              © {currentYear} LevántateCuba. Todos los derechos reservados.
            </p>
            ...
            <div className="flex items-center gap-1 text-zinc-400 text-sm">
              Hecho con <HeartIcon className="w-4 h-4 text-red-500" /> por la libertad
            </div>
          </div>
        </div>
      </div>
