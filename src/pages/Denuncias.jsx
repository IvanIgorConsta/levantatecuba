        ...
        <div className="px-4 pt-4 pb-3">
          <div className="flex items-start gap-3">
            <div className={`w-12 h-12 rounded-full flex items-center justify-center font-bold text-lg flex-shrink-0 ${
              isDestacada ? 'bg-purple-500 text-black' : 'bg-red-500 text-white'
            }`}>
            ...
            <div className="flex-1 min-w-0">
              <div className="flex items-center gap-2">
                ...
                <Dot className="w-3 h-3 text-zinc-500" />
                <span className="text-sm text-zinc-500">{timeAgo(d.createdAt)}</span>
              </div>
              ...
              <div className="mt-4 flex items-center justify-between border-t border-zinc-800 pt-3">
                <div className="flex items-center gap-1">
                  <button
                    ...
                    className={`flex items-center gap-2 px-3 py-2 rounded-lg transition hover:bg-zinc-900 ${
                      animLikes[d._id] ? 'scale-110' : 'scale-100'
                    }`}
                  >
                    <Heart className="w-5 h-5 text-zinc-500 hover:text-red-500 transition" />
                    <span className="text-sm text-zinc-400">{likes[d._id] || 0}</span>
                  </button>
                  ...
                  >
                    <MessageCircle className="w-5 h-5 text-zinc-500 hover:text-blue-500 transition" />
                    <span className="text-sm text-zinc-400">{d.comentarios?.length || 0}</span>
                  </button>
                  ...
                  <button
                    ...
                    className="flex items-center gap-2 px-3 py-2 rounded-lg transition hover:bg-zinc-900"
                  >
                    <Share2 className="w-5 h-5 text-zinc-500 hover:text-green-500 transition" />
                  </button>
                </div>
                ...
                {d.comentarios?.length > 0 && (
                  <span className="text-xs text-zinc-500">
                    ...
                    {d.likes + (d.comentarios?.length || 0) * 2} interacciones
                  </span>
                )}
              </div>
      ...
      <div className="max-w-6xl mx-auto px-4 md:px-6">
        ...
        {denuncias.length > 0 && (
          <div className="grid grid-cols-3 gap-3 mb-6">
            <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-3 text-center">
              ...
              <p className="text-xs text-zinc-500">Total denuncias</p>
            </div>
            <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-3 text-center">
              <p className="text-2xl font-bold text-white">{destacadas.length}</p>
              <p className="text-xs text-zinc-500">Destacadas</p>
            </div>
            <div className="bg-zinc-900 border border-zinc-800 rounded-lg p-3 text-center">
        ...
        {denuncias.length === 0 ? (
          ...
          <div className="space-y-4">
            ...
            {/* CTA al final */}
            <div className="mt-8 text-center py-8 bg-zinc-900/50 border border-zinc-800 rounded-xl">
              <p className="text-zinc-400 mb-4">
                ¿Tienes algo que reportar? Tu aporte ayuda a visibilizar problemas reales.
              </p>
              <a
                href={isLoggedIn ? "/romper" : "/login?redirect=/romper"}
                className="inline-flex items-center gap-2 px-6 py-3 bg-red-500 hover:bg-red-600 text-white font-medium rounded-lg transition"
